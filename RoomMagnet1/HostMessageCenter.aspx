                                 ...
                                 <div class="col-md-12">
                                     <div class="row"style="margin-left:1rem;">
                                         ...
                                         <div class="col-md-10" id="rightDiv" runat="server">
                                             ...
                                             <p><asp:TextBox ID="txtBoxReply" runat="server" TextMode="MultiLine" style="height:50px; width:75%; font-size:14pt;" ForeColor="Gray" Placeholder="Write a message..."></asp:TextBox></p>
                                             </div>
                                                 </div>
